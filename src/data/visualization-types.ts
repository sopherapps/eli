      ...
      datasetConfigGenerator: (time: Date) => ({
        ...
        configs: [
          ...
          },
          {
            ...
            label: "x-axis field [bar dataset]",
            inputType: HTMLInputType.Text,
            required: true,
            options: {},
          },
          {
            ...
            label: "y-axis field [bar dataset]",
            inputType: HTMLInputType.Text,
            required: true,
            options: {},
          },
      ...
      datasetConfigGenerator: (time: Date) => ({
        ...
        configs: [
          ...
          },
          {
            ...
            label: "x-axis field [line dataset]",
            inputType: HTMLInputType.Text,
            required: true,
            options: {},
          },
          {
            ...
            label: "y-axis field [line dataset]",
            inputType: HTMLInputType.Text,
            required: true,
            options: {},
          },
          {
            ...
            label: "chart style [line dataset]",
            inputType: HTMLInputType.Select,
            options: {
              options: ["dotted", "normal"],
              default: "normal",
          ...
          },
          {
            ...
            label: "color of area under line [line dataset]",
            inputType: HTMLInputType.Color,
            options: {},
          },
        ],
