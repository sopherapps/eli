/**
 * Module containing tests for the Doughnut chart visualization
 */
...
const emptyResponseServerUrl = "ws://doughnut-chart-empty-response.com";
const singleDatasetServerUrl =
  "ws://doughnut-chart-single-dataset-response.com";
const multipleDatasetServerUrl =
  "ws://doughnut-chart-multiple-dataset-response.com";
...
beforeEach(async () => {
  ...
  userEvent.selectOptions(visualizationTypeInput, ["doughnut-chart"]);
});
